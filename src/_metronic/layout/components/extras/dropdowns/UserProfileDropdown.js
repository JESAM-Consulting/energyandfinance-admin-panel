  ...
  return (
    <Dropdown drop="down" alignRight>
      ...
      >
        ...
        >
          {/* /text-muted */}
          <span className="font-weight-bold font-size-base d-md-inline mr-1" style={{color:"#9DBC78"}}>
            Hi,
          </span>{" "}
          
            <>
              <span className="font-weight-bolder font-size-base d-md-inline mr-3" style={{color:"#9DBC78"}}>
                {userInfo?.adminEmail === "admin@jesamconsulting.com" ? "JESAMCONSULTIG"  : "ENERGYFINANCE" }
              </span>
              <span className="symbol symbol-35 symbol-light-success">
                <span className="symbol-label font-size-h5 font-weight-bold" style={{color:"white"}}>
                  {/* {userInfo?.firstName[0]?.toUpperCase()} */}
                  {userInfo?.adminEmail === "admin@jesamconsulting.com" ? "J"  : "E" }
                </span>
              </span>
            </>
        ...
        <div className="navi navi-spacer-x-0 ">
          <div className="navi-footer"> 
            <div
              ...
              style={{backgroundColor: "#93c45e", color: "#FFFFFF" ,whiteSpace:"nowrap"}}
            >
              Ausloggen
            </div>
          </div>
